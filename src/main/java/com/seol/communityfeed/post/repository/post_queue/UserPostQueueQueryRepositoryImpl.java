...
import com.seol.communityfeed.post.repository.entity.like.QLikeEntity;
import com.seol.communityfeed.post.repository.entity.post.QPostEntity;
import com.seol.communityfeed.post.repository.entity.post.QUserPostQueueEntity;
        ...
        return queryFactory
                .select(
                        Projections.fields(
                                ...
                                userEntity.info.profileImageUrl.as("userProfileImage"),
